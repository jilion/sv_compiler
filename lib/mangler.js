...
module.exports = {
  ...
  revertMangle: function(name, contextName) {
    ...
    console.log(context.reverse_mangles[name])
    return (context) ? context.reverse_mangles[name] : null;
  },

  isReservedJSName: function(name) {
  ...
  mangle: function(name, contextName) {
    ...
    if (context) {
      if (context.mangles[name]) {
        ...
        while(Object.prototype.hasOwnProperty.call(context.mangles, m) || this.isReservedJSName(m)) {
